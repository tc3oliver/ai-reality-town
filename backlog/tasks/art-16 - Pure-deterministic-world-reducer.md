...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 FR-D005: Reducer reads no database, external API, current clock, or unfixed randomness.
- [ ] #2 FR-D005: Identical initial state and ordered events produce identical projections.
- [ ] #3 FR-D005: Unsupported versions and sequence gaps fail explicitly.
- [ ] #4 Reducer unit/property tests cover every supported event version.
<!-- AC:END -->
