...
- [ ] #1 FR-E003: 每次檢索有數量上限。
- [ ] #2 FR-E003: 檢索結果可追蹤。
- [ ] #3 FR-E003: 不得將完整歷史放入每次 Prompt。
- [ ] #4 FR-E003: 不得返回角色無權取得的記憶。
- [ ] #5 Automated tests provide evidence for every mapped FR-E003 acceptance criterion, including rejection and failure paths.
