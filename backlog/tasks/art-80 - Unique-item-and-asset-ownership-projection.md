...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Every ownership change references an accepted event and previous ownership state.
- [ ] #2 A unique item has at most one current owner or custodian.
- [ ] #3 Transfer replay is deterministic and duplicate/retried transfers remain idempotent.
<!-- AC:END -->
