...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 FR-B002: 關係變化必須具有原因與來源事件。
- [ ] #2 FR-B002: 關係數值不得超出定義範圍。
- [ ] #3 FR-B002: 關係歷史必須可查詢。
- [ ] #4 FR-B002: 關係的雙向數值可以不同。
- [ ] #5 FR-B002: 關係變化不得直接暴露未公開 Secret。
- [ ] #6 Automated tests provide evidence for every mapped FR-B002 acceptance criterion, including rejection and failure paths.
