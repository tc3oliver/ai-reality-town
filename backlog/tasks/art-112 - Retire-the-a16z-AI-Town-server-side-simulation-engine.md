...
**Goal:** Decommission the a16z server-side simulation lifecycle while preserving all client-side visual capability for reuse.
...
**Documentation Impact:** Update upstream/architecture docs describing the retained-visual / retired-engine split.
