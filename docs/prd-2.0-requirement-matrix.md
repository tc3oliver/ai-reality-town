...
| FR-N005 Location Visual Binding（8） | New | ART-110 | Done | P0 | `convex/visualBinding/`：八個 Zone 由 `data/mistwood.ts` 的 footprint／collision 推導，label 取自 `mistwoodSeed.ts`；抵達判定為多邊形包含（見 `docs/mistwood-location-bindings.md`） | ART-109 |
