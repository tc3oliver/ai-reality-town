...
| FR-N008 素材授權與 Attribution | New | ART-108, ART-143, ART-144 | ART-108 **Done**；ART-143 **Blocked**（H06 授權決策）；ART-144 To Do | P0 | ART-143：f1–f8 角色美術 provenance 經 primary source 調查仍無法確認，維持 quarantined；ART-144：`PUBLIC_BUNDLE_PATHS` 與 vite 實際輸出不一致，16 個非 approved 素材已進入 `dist/` | ART-107 |
