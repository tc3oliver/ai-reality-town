...
- **2026-09-09 — FR-M004** moved `Deferred P1` → `Delivered` (ART-91,
  `docs/model-outage-degradation.md`), which takes the deferred count from 21 to 20 and closes the
  last open clause in Epic M. Two things are worth stating plainly rather than leaving implied.
...
| **Deferred P1/P2** (explicitly out of MVP, owned by a backlog task, does not compromise safety / core experience) | 20 | No |
