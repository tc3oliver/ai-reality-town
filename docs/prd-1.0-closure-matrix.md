...
| §5.1 G11 | Daily viewer vote on an environment event | P1 delivered | ART-45 (Done, FR-J001) | `convex/viewer/environmentVote.test.ts`, `environmentVoteInjection.test.ts`; design note `docs/daily-environment-vote.md` |
