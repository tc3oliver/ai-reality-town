...
import * as worldModeControlFunctions from '../operations/worldModeControlFunctions';
...
import * as tokenBudgetFunctions from '../operations/tokenBudgetFunctions';
...
const MODULES: Readonly<Record<string, Record<string, unknown>>> = {
  ...
  'convex/operations/worldModeControlFunctions.ts': worldModeControlFunctions,
  ...
  'convex/operations/tokenBudgetFunctions.ts': tokenBudgetFunctions,
